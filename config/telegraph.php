...
return [
    ...
    'custom_webhook_domain' => env('TELEGRAPH_CUSTOM_WEBHOOK_DOMAIN', null),
    'admin_chat_ids' => [
        env('TELEGRAM_ADMIN_ID1', null),
        env('TELEGRAM_ADMIN_ID2', null),
    ],
    'admin_chat_id' => env('TELEGRAM_ADMIN_ID1', null),
    /*
     ...
     */
    'webhook_handler' => \App\Telegram\WebhookHandler::class,
